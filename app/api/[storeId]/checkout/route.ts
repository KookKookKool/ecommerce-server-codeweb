...
const corsHeaders = {
    ...
    "Access-Control-Allow-Credentials": "true"  // เพิ่มเติมหากคุณใช้ credentials
};
...
export const POST = async (
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        shipping_address_collection: {
            allowed_countries: ["TH", "US"]
        },
        phone_number_collection: {
            enabled: true,
        },
        payment_method_types: ['card', 'promptpay'], // เพิ่ม PromptPay ที่นี่
